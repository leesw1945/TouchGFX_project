...
{
    float newAngle = FloatEasingEquations::floatCubicEaseOut(step, 0, PI, duration);

    startTextureMapper.updateXAngle(newAngle);
    endTextureMapper.updateXAngle(newAngle - PI);
