...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, DISP_NRESET_Pin|SPI2_NCS_Pin|SPI1_NCS_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : SPI2_NCS_Pin SPI1_NCS_Pin */
  GPIO_InitStruct.Pin = SPI2_NCS_Pin|SPI1_NCS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
