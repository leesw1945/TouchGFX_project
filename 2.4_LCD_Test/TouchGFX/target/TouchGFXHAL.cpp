 ...
 *
 */
/* touchgfxDisplayDriverTransmitActive()/TransmitBlock() are implemented in
 * Core/Src/display_driver.c; its SPI1 TX DMA complete callback calls
 * DisplayDriver_TransferCompleteCallback() -> touchgfx::startNewTransfer(). */
